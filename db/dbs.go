// Este codigo es un inicio de sesion desde una base de datos 
...
//Parte del codigo donde se consulta un articulo
...
//Parte de codigo en php con la etiquetas $ post
...
// Parte de codigo para asignar contactos a vendedores asignados al producto
...
// Asigancion a atraves de codigo a los vednedores funcuones y dias 
...
//codigo php para guardar log de asignacion de vendedores a turnos y dias haciendo una conexion con base datos
...
// codigo php para obtener el id del cliente desde la tabla productos
...
// Codigo en php para verificar si el producto tiene marca asignada desed la tabla productos
...
// parte del codigo para mostrar el crm desde un api conexion
...
// parte del codigo donde se ejecuta todo el proceso
